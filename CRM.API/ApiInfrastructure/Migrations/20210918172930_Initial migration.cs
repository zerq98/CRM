        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadAddressId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Leads_LeadAddresses_LeadAddressId",
                        column: x => x.LeadAddressId,
                        principalTable: "LeadAddresses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SumNetValue = table.Column<double>(type: "float", nullable: false),
                    SumGrossValue = table.Column<double>(type: "float", nullable: false),
                    SumMarkupValue = table.Column<double>(type: "float", nullable: false),
                    SumVatValue = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellOpportunityHeaders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellOpportunityHeaders_AspNetUsers_TraderId",
                        column: x => x.TraderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SellOpportunityHeaders_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SellOpportunityHeaders_OpportunityStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpportunityHeaderId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellOpportunityPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellOpportunityPositions_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SellOpportunityPositions_SellOpportunityHeaders_OpportunityHeaderId",
                        column: x => x.OpportunityHeaderId,
                        principalTable: "SellOpportunityHeaders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_LeadAddressId",
                table: "Leads",
                column: "LeadAddressId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellOpportunityHeaders_CompanyId",
                table: "SellOpportunityHeaders",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_SellOpportunityHeaders_StatusId",
                table: "SellOpportunityHeaders",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_SellOpportunityHeaders_TraderId",
                table: "SellOpportunityHeaders",
                column: "TraderId");

            migrationBuilder.CreateIndex(
                name: "IX_SellOpportunityPositions_OpportunityHeaderId",
                table: "SellOpportunityPositions",
                column: "OpportunityHeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_SellOpportunityPositions_ProductId",
                table: "SellOpportunityPositions",
                column: "ProductId");
